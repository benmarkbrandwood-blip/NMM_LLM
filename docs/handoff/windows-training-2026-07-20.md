...
The historical M2 comparison passed 16 cases at MIF commit
`83e4b758f624f3059c7ba289d4d4429eed0a710a`. The final candidate-2 smoke run
on 6 August 2026 binds NMM_LLM commit
`99f0fdb46513ccdd9c7d496af7ea69944b397057`, Sanmill commit
`14e7d9d0a439929316866fe9dcae213777a8a2b8`, and MIF commit
`f37ddfeb5fb8479991fa38eeb03c797bef8ae408`. At the clean NMM_LLM commit,
45 focused tests and Ruff pass; the generator accepts the clean MIF checkout
and all six frozen hashes; and the official 17-case corpus compares equal
across all three independent adapter processes. MIFCAP now publishes the smoke
digest in `testedCorpora`, all six source and harness hashes in annotations,
and no Suite claim. The exact pin, hashes, scope, and host-local command-array
generator are in
[`docs/interop/mif-1.0-independent-adapter.md`](../interop/mif-1.0-independent-adapter.md).
The raw
[comparator report](../evidence/mif-interop-candidate-2-report-2026-08-06.json)
has SHA-256
...
The NMM_LLM adapter remains accepted for M2, and its candidate-2 capability,
pin and persisted smoke evidence are complete. The 17th case passes without an
NMM_LLM state-machine or canonicalization change. This is still not M3 or
Suite conformance: the three-project plan reserves M3 for the complete
deterministic corpus, and this NMM_LLM report does not replace Sanmill's own
