...
| Human game files | `data/human_games`, 95,389 `.jsonl` occurrences plus import metadata; F0-D0 resolves these to 94,540 unique sessions and 849 byte-identical duplicate exports; the 20 July author update added 406 current sessions without rebuilding the active HumanDB |
| F0-D0 raw-corpus manifest | Tracked compact JSON at `docs/evidence/f0-d0-human-raw-reconstructability-manifest-2026-08-14.json`; 30,378,269 bytes, file SHA-256 `0ab20955d551351ac25885b54d59a9f63fb6b2708e3292404d71dab2ff7dace6`, manifest identity `bf7404d1f090073a1b36635b89d329e7011140d48e4fb3b3076efd7e55b5bca7`, and current raw-corpus identity `4c54d55209543e70edaeb33cb1dea25d2707312c3781580ba326ae35882dea29`; records every input SHA and every session recovery/failure attribution, authorizes no later F0 gate, and does not open or consume the `2eb04f54` source-pool artifact |
| F0-H0 official B2 split | Tracked plan `docs/experiments/f0-h0-design-b2-freeze-and-characterization-v1.json`, identity `a4dc271d00a36394d4e5b61751f7536cf3e869cb90136fbe7bedd6016c6acb30`; frozen membership `docs/experiments/f0-h0-design-b2-frozen-membership-v1.json`, identity `06c49903baf76ee7787af8333058e164cb54ea7a27035a1371747d6000d07b0b`; and result `docs/evidence/f0-h0-design-b2-freeze-characterization-manifest-2026-08-15.json`, identity `183a39ab29ddfbec76a7188606b0a1297ffbdb845346a05753807f2c609b65e6`. The split contains 36,949/887/386/847 train/selection/confirmation/final-test sessions. Final-test content remains sealed; the result characterizes only the first three partitions and freezes a 10,000-game Malom-cost fallback sample. It is not an F0-H0 scientific screen or later-gate authority. |
| F0-H0 B2 train-only rejection screen | The original immutable plan `docs/experiments/f0-h0-b2-train-rejection-screen-v1.json`, identity `dd87175dc950cbcde4b0b44cd5d4a8da0b039dcbd3cacaf198ba43ec00de0bdc`, and historical result `docs/evidence/f0-h0-b2-train-rejection-screen-manifest-2026-08-15.json`, identity `84434066d5c4fc58fd82585a32c5bff9ef69ecfe4badb2a0c3289b4b0fb7068b`, remain unchanged. A zero-event estimator defect makes that result non-decisional. Corrected technical-replay plan `docs/experiments/f0-h0-b2-train-rejection-screen-v2.json`, identity `a6972c3dae62ec249ccf6ea7bc7bf46132288a15db41b1c33b347b75615a9d0c`, keeps the exact sample and threshold object; corrected result `docs/evidence/f0-h0-b2-train-rejection-screen-v2-manifest-2026-08-15.json`, identity `8bd2da62785e9c8cda0a055e98213959cbdf8f88aa860384171f00f4f39c6bdc`, triggers the stop condition on support and concentration. It opens only the 9,113-game train intersection and records zero selection, confirmation, final-test, source-pool, game, search, model, training, or database-write operations. Preserve both result manifests; E0 and later gates remain closed. |
| Human feature-deviation estimator readiness | Immutable numerical plans `docs/experiments/human-feature-deviation-estimator-readiness-v1.json` and `human-feature-deviation-estimator-readiness-v2.json` have identities `0ed6030a41efc91724fa5ab453a5d126d1ab55923182629451e067dd6cdfcbb3` and `246eef0ae2c42cb6606b8fa28a2ebb323f7ef65b7a80bdc09e4e456fba43eb87`. The v1 structure failed before raw access; v2 changes only the outcome-blind fold assignment. Frozen cross-fit structure `docs/experiments/human-feature-deviation-estimator-crossfit-v1.json` has identity `b2ab654856a13d17fbc5256b6395c078e6cd13db9114da390daf720d952e6ae4`. Result `docs/evidence/human-feature-deviation-estimator-readiness-manifest-2026-08-15.json`, identity `0df4a8bcfab8636048c8b005945a1d4bd719b23f377c06d25a6d6e5b745d0ec2`, is `B_not_ready_fail_closed` because the conservative player-level log-loss SD exceeds the frozen power ceiling. It used only 6,400 research-exploration games and left research confirmation plus official selection, confirmation, and final-test unopened. It authorizes no later gate, game, training, product claim, or protected access. |
| Human feature-deviation product conversion | Immutable derivation v1 `docs/experiments/human-feature-deviation-product-conversion-derivation-v1.json` has identity `5f45c0296d86553b7fa67e1aea45269690da15ccf00d840f0c3709479c575e1b`. V2, identity `d4ead92b6ff1b8be07d5a16ab1041547e973ee50d4ae794e3ab5fc1a06d20444`, corrects only three narrative-rounded exact-reproduction values before any new successor query. Result `docs/evidence/human-feature-deviation-product-conversion-manifest-2026-08-15.json`, identity `3da605d1d92d1a53b00dc9dabda1ac95c2e4624ec53354bddc0f8a7f53301d5f`, is `C_conversion_not_established`: predictive safe-successor risk does not identify causal inducement, policy visitation, or redemption. It made 44,347,095 read-only Malom queries on the same 6,400 exploration games, refit no estimator, and opened no research-confirmation, official holdout, HumanDB, or source-pool content. It creates no new question or downstream authority. |
| Retained-v3/v4 late-import held-out source pool | Tracked source-only artifact `docs/experiments/sanmill-retained-v3-v4-late-import-heldout-pool-v1.json`, pool identity `2eb04f542f88f8360f08f97e7657ca15646582a1532358dfeb04182ebad7d8f7`, records identity `4e5f9ecf7508a995b74af6a36bcf966c89d9141940770ebb21c3629446830a31`. It contains 361 complete-history, source-game-unique and `ring16`-unique starts selected without a candidate policy or source outcome. Every start is absent under D4 from the active route HumanDB and both retained candidate SpecialistDB snapshots, is disjoint from prior frozen corpus orbits, and passed two fresh-process strict Sanmill replays. Its 253-record prefix `99951a69` was consumed by the retained-v3/v4 held-out score, and its final 108-record suffix `98532911` was consumed once by the product-route held-out comparison on 21 August 2026. Zero records remain unconsumed. Preserve the source artifact and order; do not reuse any record as fresh held-out evidence. |
| Product-route final-suffix held-out result | Frozen plan `docs/experiments/sanmill-product-route-heldout-v1.json`, identity `bae8e6ad8d23ba42f6ac68e5a3b8dcb8e9d53a98670e53637486f97989d1b0e1`, and consumed authorization `9b28bdda1357081a72a18abf28736d18194134d57c16c32a12a771302158741c` bind the current published `dev` product routes. The tracked result `docs/evidence/sanmill-product-route-heldout-v1-manifest-2026-08-21.json`, identity `89d24d3abc99811ee644a00e99d300c5721c8d1410a7c1458370ff15ce80f28d`, summarizes 864 strict-terminal games. Independent recomputation identity `7d4685acc5b5c8c6e01bd79f864d4455476e72a8dde14ca1f96fe105b0e1baf0` matches both D9 and D10 primary objects. The ignored raw ledger remains at `out/evaluation/sanmill-product-route-heldout-v1-20260821-001/games.jsonl`, 864 records, SHA-256 `b42d9af4ef2694e6882d6a535b4543ce167f8f3809c903baee634cd1854fa1ca`; preserve the whole output namespace read-only. |
...
| Retained-v3/v4 cross-corpus read-only view | `tools/serve_retained_phase_process_generalization.py` accepts the completed phase root through `--output-root`, the completed reused-development root through optional `--development-output-root`, and the tracked candidate-blind source pool through `--heldout-pool`. It identity-checks and independently reaggregates the existing ledgers, validates the source-pool histories, and displays start-clustered survival, score precision, conservative fixed-width planning, pool exposure support, strict replay support and phase-covered nested-prefix feasibility. It creates no game and grants no authority. The tracked synthesis is `docs/evidence/sanmill-retained-v3-v4-cross-corpus-synthesis-2026-08-14.md`. |
| Retained-v3/v4 high-precision held-out successor inputs | Ignored read-only copies under `learned_ai/checkpoints/evaluation/sanmill-retained-v3-v4-heldout-score-v1/inputs`, snapshot identity `1ceb11ce5cec1ff44a9c1f03d69a961f191bdd951d7fe31ef078bb40bf2874c3`, canonical manifest SHA-256 `2918d2de63001135de33c1296656d49aefb8f182e721472c5dfc643378004b92`. The bundle, file-list and sidecar-free SpecialistDB identities remain byte-equal to the phase successor inputs. These are read-only evaluation inputs, not training lineage, and their existence grants no launch authority. |
| Retained-v3/v4 high-precision held-out frozen plan | Tracked canonical plan `docs/experiments/sanmill-retained-v3-v4-heldout-score-v1.json`, identity `6620821e879f53058d15990cd0e8c884ae62fec213b3d96200e8894c20e19714`, file SHA-256 `7e523265bc8d0b6ae5d861919033a86af2bbdb9238d54991f57d57d8161a0f24`, implementation commit `5eb142383f710c17377deedc8b1cfcc5287daa02`, plan commit `592950062515f697b52c8e8d355aa091da4cc839`, stable source readiness `f233c991aa66a8699fac8952fd0c758a5fabb09de7a0e66ba3043635934b2b08`. It binds the first 253 frozen held-out starts, 1,012 games, target 1.5pp engineering half-width and four active hours. Direct authorization was later consumed by the completed result below. Preserve the immutable JSON and do not rerun or extend the consumed prefix. |
| Retained-v3/v4 high-precision held-out completed result | Ignored runtime under `learned_ai/checkpoints/evaluation/sanmill-retained-v3-v4-heldout-score-v1`: authorization `816cc390b6850b02cf3cb36afdc78daf154a4d4e982d6798fb633376ea6f2503`, readiness `765c0829e272cf53f3fc6178cd8f83621c8de2fc3653be298df6ff70683b2ef4`, spec `cb736759790989ee6a4bd6bd1f6f965e4341c67729da6249e2d91d585b4fa943`, launch `b4505be8f06c217a3e57994b3ae6ddb30957ac0b8bd56a7a6ead49f1f1c6a4a2`, 1,012-row ledger SHA-256 `7dd72447a4e918e5ee816604f18b5e3497a002a2969d1ca22119043a8df8fc45`, result `8d7a4a0aefdd9b0716cccfa3a8d9ace44493c870cc9c9eed885bc7fd35c74730`, completion `8949a8fdc0c38772b40e348d7e645ec70aed3cd76663d426320154b0e708ac7c`. All games reached strict terminals, zero hit the cap, and the primary decision is `v4_higher_fixed_heldout_score`: +1.6798pp, interval [+0.6195pp, +2.7402pp]. Preserve the namespace read-only; this is a named-route fixed-corpus result, not refresh causality, Elo, automatic promotion, publication or release evidence. |
...
future decision. Those 406 files are now bound read-only as the source universe
for held-out pool identity `2eb04f54`; this does not make them part of the
active HumanDB and they must not be imported there before any separately
authorized evaluation using that pool is complete. The active database's
