...
| Retained-v3/v4 phase-process frozen plan | Tracked canonical plan `docs/experiments/sanmill-retained-v3-v4-phase-process-generalization-v1.json`, plan identity `7dfd8e32451a43acaddf1d8bc654c560779a96e60029aecb22d34cfbe7d8c367`, file SHA-256 `fad47ecaf0b6de0edc4e323a926e65a5cbaf24a77bdb38f760c3f75939d364b9`, implementation commit `32e8843b791ea0ebbf149b5ad4ccfb96ad13318f`. It binds 39 starts / 156 games / two active hours, a relative 108-ply start-clustered process endpoint, and zero-new-game mechanism reanalysis. It is locally frozen but supplies no authority; runtime JSON files other than `inputs/manifest.json` remain absent. |
