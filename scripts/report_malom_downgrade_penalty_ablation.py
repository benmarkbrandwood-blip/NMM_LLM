#!/usr/bin/env python3
"""Validate and publish the completed downgrade-penalty ablation result."""
...
from learned_ai.evaluation.malom_downgrade_penalty_result import (  # noqa: E402
    DEFAULT_CONTRACT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = analyze_penalty_ablation_result(
            root=ROOT,
