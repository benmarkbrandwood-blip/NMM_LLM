#!/usr/bin/env python3
"""Analyze and publish the frozen target-refresh/LR diagnostic once."""
...
from learned_ai.evaluation.target_refresh_lr_factorial_result import (  # noqa: E402
    DEFAULT_RESULT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        report = analyze_target_refresh_lr_result(
            root=ROOT,
    ...
    except (TargetRefreshLrResultError, OSError, ValueError) as exc:
