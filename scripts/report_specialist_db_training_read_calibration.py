#!/usr/bin/env python3
"""Validate and publish the SpecialistDB training-read calibration result."""
...
from learned_ai.evaluation.specialist_db_training_read_calibration_result import (  # noqa: E402
    DEFAULT_CONTRACT,
...
from learned_ai.training.managed_generalist import ManagedContractError  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = analyze_specialist_read_calibration_result(
            root=ROOT,
        ...
        print(
            json.dumps(
                {"state": "not_reportable", "reason": str(exc)},
                indent=2,
                sort_keys=True,
            )
        )
