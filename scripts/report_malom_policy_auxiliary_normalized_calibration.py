#!/usr/bin/env python3
"""Validate and publish the six-arm normalized auxiliary calibration result."""
...
from learned_ai.evaluation.malom_policy_auxiliary_normalized_calibration_result import (  # noqa: E402
    DEFAULT_CONTRACT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = analyze_normalized_calibration_result(
            root=ROOT,
