#!/usr/bin/env python3
"""Validate and publish the completed six-arm mill-bonus ablation result."""
...
from learned_ai.evaluation.mill_bonus_ablation_result import (  # noqa: E402
    DEFAULT_CONTRACT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = analyze_ablation_result(
            root=ROOT,
