#!/usr/bin/env python3
"""Audit or prepare the target-refresh common-anchor diagnostic."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.prepare:
            ...
            report = prepare_target_refresh_common_anchor_diagnostic(
                root=ROOT,
    ...
    except (TargetRefreshCommonAnchorError, OSError, ValueError) as exc:
        print(
            json.dumps(
                {
                    "state": "not_ready",
