#!/usr/bin/env python3
"""Audit or prepare the three-seed normalized auxiliary calibration."""
...
from learned_ai.validation.malom_policy_auxiliary_normalized_calibration_readiness import (  # noqa: E402
    DEFAULT_CONTRACT,
    ...
    prepare_normalized_calibration,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.prepare:
            ...
            result = prepare_normalized_calibration(
                root=ROOT,
            ...
            result = inspect_source_readiness(
                root=ROOT,
                contract_path=contract_path,
                paths_config=paths_config,
                python_executable=sys.executable,
            ...
            if args.write_source_readiness:
                publish_source_readiness(source_report_path, result)
    except (
        MalomPolicyAuxiliaryNormalizedCalibrationReadinessError,
        OSError,
        ValueError,
