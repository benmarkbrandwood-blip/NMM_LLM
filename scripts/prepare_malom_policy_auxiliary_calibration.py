#!/usr/bin/env python3
"""Audit or prepare the frozen Malom policy-auxiliary calibration."""
...
from learned_ai.validation.malom_policy_auxiliary_calibration_readiness import (  # noqa: E402
    DEFAULT_CONTRACT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="tracked source-only calibration contract",
    )
    parser.add_argument(
        "--paths-config",
